...
def umap_plot(pcw):
    ...
    fig, axes = plt.subplots(n_section, 3, figsize=(21, 7 * n_section), constrained_layout=True)
    ...
    fig.tight_layout()
    fig.savefig(os.path.join(fig_dir, 'spatial-{}-umap-{}.png'.format(model, pcw)), dpi=200)
    plt.close()
