...
# %%
es_callback = keras.callbacks.EarlyStopping(monitor='loss', min_delta=0, patience=1, restore_best_weights=True)
...
# %%
node_gen = GraphSAGENodeGenerator(g, batch_size, num_samples, weighted=True).flow(g.nodes())
