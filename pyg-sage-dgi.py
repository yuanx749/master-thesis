"""Deep Graph Infomax GraphSAGE by PyTorch Geometric."""
...
model_name = model_dir / time.strftime("sage-dgi-%Y%m%d.pt")
...
embedding_name = time.strftime(
    "{}-embedding-%Y%m%d-%H%M%S.npy".format(type(model.encoder).__name__)
)
