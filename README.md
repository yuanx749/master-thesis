...
## Scripts
All the scripts can run in notebook mode. The function of each script and the corresponding figures produced in the thesis are listed below. Refer to the scripts for more descriptions.
